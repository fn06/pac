...
let test_initial_state () =
  ...
  let state = create_initial_state simple_deps simple_query in
...
let test_minimal_solve () =
  ...
  match solve empty_deps empty_query with
  | Solution packages -> 
