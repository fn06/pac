  ...
  trying version 1.0.0
  dependency incompatibilities
  	(terms: {shared [1.0.0, 2.0.0), not target 1.0.0}, cause: dependency shared 1.0.0 -> target 1.0.0)
  not adding decision due to conflict
  unit propagation on: shared
  conflict resolution on: (terms: {shared [1.0.0, 2.0.0), not target 1.0.0}, cause: dependency shared 1.0.0 -> target 1.0.0)
  ...
  new assignment on level 0: Derivation not shared [1.0.0, 2.0.0) due to incompatibility (terms: {shared [1.0.0, 2.0.0), not target 1.0.0}, cause: dependency shared 1.0.0 -> target 1.0.0)
  unit propagation on: shared
  deciding on target: 2.0.0
  trying version 2.0.0
  assignment on level 1: Decision target 2.0.0
  ...
  backtracking to level 0
  solution: (0: Derivation not shared [1.0.0, 2.0.0) due to incompatibility (terms: {shared [1.0.0, 2.0.0), not target 1.0.0}, cause: dependency shared 1.0.0 -> target 1.0.0)), (0: Derivation target 2.0.0 due to incompatibility (terms: {Root *, not target 2.0.0}, cause: dependency root -> target 2.0.0)), (0: Derivation foo 1.0.0 ∪ 1.1.0 due to incompatibility (terms: {Root *, not foo 1.0.0 ∪ 1.1.0}, cause: dependency root -> foo 1.0.0 ∪ 1.1.0)), (0: Decision root)
  ...
  prior cause (terms: {foo [1.0.0, +∞)}, cause: ((terms: {not baz 3.0.0, foo [1.0.0, +∞)}, cause: ((terms: {foo [1.0.0, +∞), not bar 2.0.0}, cause: dependency foo 1.0.0 -> bar 2.0.0) and (terms: {bar [2.0.0, +∞), not baz 3.0.0}, cause: dependency bar 2.0.0 -> baz 3.0.0))) and (terms: {Root *, not baz 1.0.0}, cause: dependency root -> baz 1.0.0)))
  conflict resolution on: (terms: {foo [1.0.0, +∞)}, cause: ((terms: {not baz 3.0.0, foo [1.0.0, +∞)}, cause: ((terms: {foo [1.0.0, +∞), not bar 2.0.0}, cause: dependency foo 1.0.0 -> bar 2.0.0) and (terms: {bar [2.0.0, +∞), not baz 3.0.0}, cause: dependency bar 2.0.0 -> baz 3.0.0))) and (terms: {Root *, not baz 1.0.0}, cause: dependency root -> baz 1.0.0)))
  ...
  trying version 1.0.0
  dependency incompatibilities
  	(terms: {foo [1.0.0, 1.1.0), not b 1.0.0}, cause: dependency foo 1.0.0 -> b 1.0.0)
  	(terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0)
  assignment on level 1: Decision foo 1.0.0
  unit propagation on: foo
  new assignment on level 1: Derivation b 1.0.0 due to incompatibility (terms: {foo [1.0.0, 1.1.0), not b 1.0.0}, cause: dependency foo 1.0.0 -> b 1.0.0)
  new assignment on level 1: Derivation a 1.0.0 due to incompatibility (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0)
  unit propagation on: a
  unit propagation on: b
  deciding on a: 1.0.0
  trying version 1.0.0
  ...
  satisfiying assignment on level 1: Derivation a 1.0.0 due to incompatibility (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0)
  prior cause (terms: {not b 2.0.0, foo [1.0.0, 1.1.0)}, cause: ((terms: {a [1.0.0, +∞), not b 2.0.0}, cause: dependency a 1.0.0 -> b 2.0.0) and (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0)))
  conflict resolution on: (terms: {not b 2.0.0, foo [1.0.0, 1.1.0)}, cause: ((terms: {a [1.0.0, +∞), not b 2.0.0}, cause: dependency a 1.0.0 -> b 2.0.0) and (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0)))
  satisfiying assignment on level 1: Derivation b 1.0.0 due to incompatibility (terms: {foo [1.0.0, 1.1.0), not b 1.0.0}, cause: dependency foo 1.0.0 -> b 1.0.0)
  backtracking to level 0
  ...
  new incompatibility (terms: {not b 2.0.0, foo [1.0.0, 1.1.0)}, cause: ((terms: {a [1.0.0, +∞), not b 2.0.0}, cause: dependency a 1.0.0 -> b 2.0.0) and (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0)))
  new assignment on level 0: Derivation b 2.0.0 due to incompatibility (terms: {not b 2.0.0, foo [1.0.0, 1.1.0)}, cause: ((terms: {a [1.0.0, +∞), not b 2.0.0}, cause: dependency a 1.0.0 -> b 2.0.0) and (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0)))
  unit propagation on: b
  conflict resolution on: (terms: {foo [1.0.0, 1.1.0), not b 1.0.0}, cause: dependency foo 1.0.0 -> b 1.0.0)
  satisfiying assignment on level 0: Derivation b 2.0.0 due to incompatibility (terms: {not b 2.0.0, foo [1.0.0, 1.1.0)}, cause: ((terms: {a [1.0.0, +∞), not b 2.0.0}, cause: dependency a 1.0.0 -> b 2.0.0) and (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0)))
  prior cause (terms: {foo [1.0.0, 1.1.0)}, cause: ((terms: {foo [1.0.0, 1.1.0), not b 1.0.0}, cause: dependency foo 1.0.0 -> b 1.0.0) and (terms: {not b 2.0.0, foo [1.0.0, 1.1.0)}, cause: ((terms: {a [1.0.0, +∞), not b 2.0.0}, cause: dependency a 1.0.0 -> b 2.0.0) and (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0)))))
  conflict resolution on: (terms: {foo [1.0.0, 1.1.0)}, cause: ((terms: {foo [1.0.0, 1.1.0), not b 1.0.0}, cause: dependency foo 1.0.0 -> b 1.0.0) and (terms: {not b 2.0.0, foo [1.0.0, 1.1.0)}, cause: ((terms: {a [1.0.0, +∞), not b 2.0.0}, cause: dependency a 1.0.0 -> b 2.0.0) and (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0)))))
  satisfiying assignment on level 0: Derivation foo 1.0.0 due to incompatibility (terms: {Root *, not foo 1.0.0}, cause: dependency root -> foo 1.0.0)
  prior cause (terms: {Root *}, cause: ((terms: {foo [1.0.0, 1.1.0)}, cause: ((terms: {foo [1.0.0, 1.1.0), not b 1.0.0}, cause: dependency foo 1.0.0 -> b 1.0.0) and (terms: {not b 2.0.0, foo [1.0.0, 1.1.0)}, cause: ((terms: {a [1.0.0, +∞), not b 2.0.0}, cause: dependency a 1.0.0 -> b 2.0.0) and (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0))))) and (terms: {Root *, not foo 1.0.0}, cause: dependency root -> foo 1.0.0)))
  conflict resolution on: (terms: {Root *}, cause: ((terms: {foo [1.0.0, 1.1.0)}, cause: ((terms: {foo [1.0.0, 1.1.0), not b 1.0.0}, cause: dependency foo 1.0.0 -> b 1.0.0) and (terms: {not b 2.0.0, foo [1.0.0, 1.1.0)}, cause: ((terms: {a [1.0.0, +∞), not b 2.0.0}, cause: dependency a 1.0.0 -> b 2.0.0) and (terms: {foo [1.0.0, 1.1.0), not a 1.0.0}, cause: dependency foo 1.0.0 -> a 1.0.0))))) and (terms: {Root *, not foo 1.0.0}, cause: dependency root -> foo 1.0.0)))
  Because a 1.0.0 -> b 2.0.0 and foo 1.0.0 -> a 1.0.0, foo [1.0.0, 1.1.0) requires b 2.0.0.
